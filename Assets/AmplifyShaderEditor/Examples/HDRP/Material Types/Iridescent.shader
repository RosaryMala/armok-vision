...
Shader "ASESampleShaders/SRP HD Material Types/Iridescent"
{
	Properties
	{
		...
		[ASEEnd]_IridescentMask("Iridescent Mask", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_IridescentMask = packedInput.ase_texcoord5.xy * _IridescentMask_ST.xy + _IridescentMask_ST.zw;
				...
				#ifdef _MATERIAL_FEATURE_IRIDESCENCE
				surfaceDescription.IridescenceMask = tex2D( _IridescentMask, uv_IridescentMask ).a;
				surfaceDescription.IridescenceThickness = _IridescenceThickness;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_IridescentMask = packedInput.ase_texcoord2.xy * _IridescentMask_ST.xy + _IridescentMask_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_IridescentMask = packedInput.ase_texcoord7.xy * _IridescentMask_ST.xy + _IridescentMask_ST.zw;
