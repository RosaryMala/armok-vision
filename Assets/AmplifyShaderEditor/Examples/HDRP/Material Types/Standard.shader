...
Shader "ASESampleShaders/SRP HD Material Types/Standard"
{
	Properties
	{
		...
		[ASEEnd]_RoughnessScale("Roughness Scale", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord16 = packedInput.ase_texcoord5.xy * float2( 2,2 ) + float2( 0,0 );
				
				surfaceDescription.Albedo = ( tex2D( _BaseColor, uv_BaseColor ) * tex2D( _MixAlbedo, texCoord16 ) ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _Normal, texCoord16 ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = tex2D( _Metallic, texCoord16 ).r;
				...
				surfaceDescription.Smoothness = ( 1.0 - ( _RoughnessScale * tex2D( _Sand_roughness, texCoord16 ).r ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord16 = packedInput.ase_texcoord2.xy * float2( 2,2 ) + float2( 0,0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord16 = packedInput.ase_texcoord3.xy * float2( 2,2 ) + float2( 0,0 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord16 = packedInput.ase_texcoord7.xy * float2( 2,2 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=18935
878;203;1920;1011;1309.767;911.9913;1.3;True;True
Node;AmplifyShaderEditor.RangedFloatNode;18;-284.9,-227.3969;Float;False;Property;_RoughnessScale;Roughness Scale;5;0;Create;True;0;0;0;False;0;False;0;0.64;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;-356.9759,-122.488;Inherit;True;Property;_Sand_roughness;Sand_roughness;4;0;Create;True;0;0;0;False;0;False;-1;ae457e1c85fba234483dfbd144088f0f;ae457e1c85fba234483dfbd144088f0f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-331.2002,-499.2003;Inherit;True;Property;_MixAlbedo;Mix Albedo;1;0;Create;True;0;0;0;False;0;False;-1;4112a019314dad94f9ffc2f8481f31bc;662d72b6ec210cf4cbeec2b4d3cb8b2a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-32,-144;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;16;-691.6021,-72.23596;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;2,2;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-340.1796,-717.6842;Inherit;True;Property;_BaseColor;Base Color;0;0;Create;True;0;0;0;False;0;False;-1;e70a4cc9a27a530468623a76c6c025fe;e70a4cc9a27a530468623a76c6c025fe;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;17;98.20857,-126.9763;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-272,96;Inherit;True;Property;_Normal;Normal;2;0;Create;True;0;0;0;False;0;False;-1;24e31ecbf813d9e49bf7a1e0d4034916;f53512d44b91e954dae7bf028209df1a;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;2.82058,-627.6844;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;13;-272,304;Inherit;True;Property;_Metallic;Metallic;3;0;Create;True;0;0;0;False;0;False;-1;84d76c914224da14a8210ba4ba8a2992;2665c395410e391469e722b3071ed218;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;28;4;13;1
WireConnection;28;7;17;0
ASEEND*/
//CHKSM=BBB6E2EC7D4DA5F999B78BF49896E58F2E11135A