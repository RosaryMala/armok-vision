...
namespace UnityStandardAssets.ImageEffects
{
    ...
    [AddComponentMenu("Image Effects/Other/Camera Overlay")]
    public class CameraOverlay : PostEffectsBase
    {
        ...
        public Camera overlayCamera = null;
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            _overlayTexture = RenderTexture.GetTemporary(Screen.width, Screen.height);
            overlayCamera.targetTexture = _overlayTexture;
            overlayCamera.Render();

            overlayMaterial.SetVector("_UV_Transform", UV_Transform);
            overlayMaterial.SetFloat("_Intensity", intensity);
            overlayMaterial.SetTexture("_Overlay", _overlayTexture);
            Graphics.Blit(source, destination, overlayMaterial, (int)blendMode);
            RenderTexture.ReleaseTemporary(_overlayTexture);
        }
    }
}
