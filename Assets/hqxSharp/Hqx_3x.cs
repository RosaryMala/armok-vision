...
namespace hqx
{
    public static partial class HqxSharp
    {
        ...
        public static Texture2D Scale3(Texture2D bitmap, uint trY = 48, uint trU = 7, uint trV = 6, uint trA = 0, bool wrapX = false, bool wrapY = false)
        {
            int Xres = bitmap.width;
            int Yres = bitmap.height;

            var dest = new Texture2D(bitmap.width * 3, bitmap.height * 3);
        ...
        /// <param name="wrapX">Used for images that can be seamlessly repeated horizontally.</param>
        /// <param name="wrapY">Used for images that can be seamlessly repeated vertically.</param>
        public static void Scale3(Color32[] source, Color32[] dest, int Xres, int Yres, uint trY = 48, uint trU = 7, uint trV = 6, uint trA = 0, bool wrapX = false, bool wrapY = false)
        {
            int dpL = Xres * 3;
                        ...
                        case 165:
                            {
                                ...
                                dest[destIndex + 2] = Interpolation.Mix2To1To1(patch[4], patch[1], patch[5]);
                                dest[destIndex + dpL] = Interpolation.Mix3To1(patch[4], patch[3]);
                                dest[destIndex + dpL + 1] = patch[4];
                                dest[destIndex + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[5]);
                                dest[destIndex + dpL + dpL] = Interpolation.Mix2To1To1(patch[4], patch[7], patch[3]);
                                dest[destIndex + dpL + dpL + 1] = Interpolation.Mix3To1(patch[4], patch[7]);
                                dest[destIndex + dpL + dpL + 2] = Interpolation.Mix2To1To1(patch[4], patch[5], patch[7]);
                                break;
                            }
                        case 2:
                        case 34:
                        ...
                        case 49:
                            {
                                ...
                                dest[destIndex + dpL + dpL] = Interpolation.Mix2To1To1(patch[4], patch[7], patch[3]);
                                dest[destIndex + dpL + dpL + 1] = Interpolation.Mix3To1(patch[4], patch[7]);
                                dest[destIndex + dpL + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[8]);
                                break;
                            }
                        case 64:
                        case 65:
                        ...
                        case 166:
                            {
                                dest[destIndex] = Interpolation.Mix3To1(patch[4], patch[0]);
                                dest[destIndex + 1] = patch[4];
                                dest[destIndex + 2] = Interpolation.Mix3To1(patch[4], patch[5]);
                                dest[destIndex + dpL] = Interpolation.Mix3To1(patch[4], patch[3]);
                                dest[destIndex + dpL + 1] = patch[4];
                                dest[destIndex + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[5]);
                                dest[destIndex + dpL + dpL] = Interpolation.Mix2To1To1(patch[4], patch[7], patch[3]);
                        ...
                        case 177:
                            {
                                ...
                                dest[destIndex + dpL + dpL] = Interpolation.Mix2To1To1(patch[4], patch[7], patch[3]);
                                dest[destIndex + dpL + dpL + 1] = Interpolation.Mix3To1(patch[4], patch[7]);
                                dest[destIndex + dpL + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[7]);
                                break;
                            }
                        case 192:
                        case 193:
                        ...
                        case 197:
                            {
                                ...
                                dest[destIndex + dpL + dpL] = Interpolation.Mix3To1(patch[4], patch[6]);
                                dest[destIndex + dpL + dpL + 1] = patch[4];
                                dest[destIndex + dpL + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[5]);
                                break;
                            }
                        case 96:
                        case 97:
                        ...
                        case 172:
                            {
                                ...
                                dest[destIndex + dpL + 1] = patch[4];
                                dest[destIndex + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[5]);
                                dest[destIndex + dpL + dpL] = Interpolation.Mix3To1(patch[4], patch[7]);
                                dest[destIndex + dpL + dpL + 1] = Interpolation.Mix3To1(patch[4], patch[7]);
                                dest[destIndex + dpL + dpL + 2] = Interpolation.Mix2To1To1(patch[4], patch[5], patch[7]);
                                break;
                            }
                        ...
                        case 50:
                            {
                                ...
                                {
                                    dest[destIndex + 1] = Interpolation.Mix7To1(patch[4], patch[1]);
                                    dest[destIndex + 2] = Interpolation.Mix2To7To7(patch[4], patch[1], patch[5]);
                        ...
                        case 81:
                            {
                                ...
                                else
                                {
                                    ...
                                    dest[destIndex + dpL + dpL + 2] = Interpolation.Mix2To7To7(patch[4], patch[5], patch[7]);
                                }
                                break;
                            }
                        case 72:
                        case 76:
                            {
                                ...
                                {
                                    dest[destIndex + dpL] = Interpolation.Mix7To1(patch[4], patch[3]);
                                    dest[destIndex + dpL + dpL] = Interpolation.Mix2To7To7(patch[4], patch[7], patch[3]);
                                    dest[destIndex + dpL + dpL + 1] = Interpolation.Mix7To1(patch[4], patch[7]);
                                }
                                dest[destIndex + dpL + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[8]);
                                break;
                        ...
                        case 138:
                            {
                                ...
                                {
                                    dest[destIndex] = Interpolation.Mix2To7To7(patch[4], patch[3], patch[1]);
                                    dest[destIndex + 1] = Interpolation.Mix7To1(patch[4], patch[1]);
                                    dest[destIndex + dpL] = Interpolation.Mix7To1(patch[4], patch[3]);
                                }
                                dest[destIndex + 2] = Interpolation.Mix3To1(patch[4], patch[2]);
                        ...
                        case 51:
                            {
                                ...
                                else
                                {
                                    ...
                                    dest[destIndex + 2] = Interpolation.MixEven(patch[1], patch[5]);
                                    dest[destIndex + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[5]);
                                }
                                dest[destIndex + dpL] = Interpolation.Mix3To1(patch[4], patch[3]);
                                dest[destIndex + dpL + 1] = patch[4];
                        ...
                        case 178:
                            {
                                ...
                                else
                                {
                                    dest[destIndex + 1] = Interpolation.Mix3To1(patch[4], patch[1]);
                                    dest[destIndex + 2] = Interpolation.MixEven(patch[1], patch[5]);
                                    dest[destIndex + dpL + 2] = Interpolation.Mix3To1(patch[5], patch[4]);
                                    dest[destIndex + dpL + dpL + 2] = Interpolation.Mix2To1To1(patch[4], patch[5], patch[7]);
                                }
                                dest[destIndex] = Interpolation.Mix3To1(patch[4], patch[0]);
                                dest[destIndex + dpL] = Interpolation.Mix3To1(patch[4], patch[3]);
                        ...
                        case 85:
                            {
                                ...
                                else
                                {
                                    ...
                                    dest[destIndex + dpL + 2] = Interpolation.Mix3To1(patch[5], patch[4]);
                                    dest[destIndex + dpL + dpL + 1] = Interpolation.Mix3To1(patch[4], patch[7]);
                                    dest[destIndex + dpL + dpL + 2] = Interpolation.MixEven(patch[5], patch[7]);
                                }
                                dest[destIndex] = Interpolation.Mix2To1To1(patch[4], patch[3], patch[1]);
                                dest[destIndex + 1] = Interpolation.Mix3To1(patch[4], patch[1]);
                                dest[destIndex + dpL] = Interpolation.Mix3To1(patch[4], patch[3]);
                        ...
                        case 113:
                            {
                                ...
                                else
                                {
                                    dest[destIndex + dpL + 2] = Interpolation.Mix3To1(patch[4], patch[5]);
                                    dest[destIndex + dpL + dpL] = Interpolation.Mix2To1To1(patch[4], patch[7], patch[3]);
                                    dest[destIndex + dpL + dpL + 1] = Interpolation.Mix3To1(patch[7], patch[4]);
                                    dest[destIndex + dpL + dpL + 2] = Interpolation.MixEven(patch[5], patch[7]);
                                }
                                dest[destIndex] = Interpolation.Mix2To1To1(patch[4], patch[3], patch[1]);
                                dest[destIndex + 1] = Interpolation.Mix3To1(patch[4], patch[1]);
                        ...
                        case 204:
                            {
                                ...
                                {
                                    dest[destIndex + dpL] = Interpolation.Mix3To1(patch[4], patch[3]);
                                    dest[destIndex + dpL + dpL] = Interpolation.MixEven(patch[7], patch[3]);
                                    dest[destIndex + dpL + dpL + 1] = Interpolation.Mix3To1(patch[7], patch[4]);
                                    dest[destIndex + dpL + dpL + 2] = Interpolation.Mix2To1To1(patch[4], patch[5], patch[7]);
                                }
                                dest[destIndex] = Interpolation.Mix3To1(patch[4], patch[0]);
                        ...
                        case 170:
                            {
                                ...
                                {
                                    dest[destIndex] = Interpolation.MixEven(patch[3], patch[1]);
                                    dest[destIndex + 1] = Interpolation.Mix3To1(patch[4], patch[1]);
                                    dest[destIndex + dpL] = Interpolation.Mix3To1(patch[3], patch[4]);
                                    dest[destIndex + dpL + dpL] = Interpolation.Mix2To1To1(patch[4], patch[7], patch[3]);
                                }
