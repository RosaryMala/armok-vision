...
Shader "GroundSplatSimple"
{
	Properties
	{
		...
		[ASEEnd]_NormalScale("Normal Scale", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_output_12_0_g351 = ( ( temp_output_270_0 + float2( 0,0 ) ) / appendResult265 );
				float4 tex2DNode6_g351 = tex2D( _Control, temp_output_12_0_g351 );
				float4 tex2DArrayNode23_g351 = SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,( tex2DNode6_g351.r * 255.0 ) );
				float4 tex2DNode15_g351 = tex2D( _GrassControl, temp_output_12_0_g351 );
				float2 uv_ShapeMap = packedInput.ase_texcoord5.xy;
				float4 tex2DArrayNode35_g351 = SAMPLE_TEXTURE2D_ARRAY( _ShapeMap, sampler_ShapeMap, uv_ShapeMap,( tex2DNode15_g351.g * 255.0 ) );
				float temp_output_24_0_g353 = tex2DArrayNode35_g351.b;
				float4 tex2DNode16_g351 = tex2D( _GrassTint, temp_output_12_0_g351 );
				float temp_output_25_0_g353 = tex2DNode16_g351.a;
				float4 tex2DArrayNode32_g351 = SAMPLE_TEXTURE2D_ARRAY( _ShapeMap, sampler_ShapeMap, uv_ShapeMap,( tex2DNode6_g351.g * 255.0 ) );
				float temp_output_26_0_g353 = tex2DArrayNode32_g351.b;
				float temp_output_41_0_g351 = ( 1.0 - tex2DNode16_g351.a );
				float temp_output_27_0_g353 = temp_output_41_0_g351;
				float temp_output_1_0_g353 = ( max( ( temp_output_24_0_g353 + temp_output_25_0_g353 ) , ( temp_output_26_0_g353 + temp_output_27_0_g353 ) ) - 0.2 );
				float temp_output_21_0_g353 = max( ( ( temp_output_24_0_g353 + temp_output_25_0_g353 ) - temp_output_1_0_g353 ) , 0.0 );
				float temp_output_19_0_g353 = max( ( ( temp_output_26_0_g353 + temp_output_27_0_g353 ) - temp_output_1_0_g353 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch29_g351 = ( ( ( SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,( tex2DNode15_g351.r * 255.0 ) ) * temp_output_21_0_g353 ) + ( tex2DArrayNode23_g351 * temp_output_19_0_g353 ) ) / ( temp_output_21_0_g353 + temp_output_19_0_g353 ) );
				#else
				float4 staticSwitch29_g351 = tex2DArrayNode23_g351;
				#endif
				float temp_output_24_0_g352 = tex2DArrayNode35_g351.b;
				float temp_output_25_0_g352 = tex2DNode16_g351.a;
				float temp_output_26_0_g352 = tex2DArrayNode32_g351.b;
				float temp_output_27_0_g352 = temp_output_41_0_g351;
				float temp_output_1_0_g352 = ( max( ( temp_output_24_0_g352 + temp_output_25_0_g352 ) , ( temp_output_26_0_g352 + temp_output_27_0_g352 ) ) - 0.2 );
				float temp_output_21_0_g352 = max( ( ( temp_output_24_0_g352 + temp_output_25_0_g352 ) - temp_output_1_0_g352 ) , 0.0 );
				float temp_output_19_0_g352 = max( ( ( temp_output_26_0_g352 + temp_output_27_0_g352 ) - temp_output_1_0_g352 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch31_g351 = ( ( ( tex2DArrayNode35_g351 * temp_output_21_0_g352 ) + ( tex2DArrayNode32_g351 * temp_output_19_0_g352 ) ) / ( temp_output_21_0_g352 + temp_output_19_0_g352 ) );
				#else
				float4 staticSwitch31_g351 = tex2DArrayNode32_g351;
				#endif
				float temp_output_302_3 = staticSwitch31_g351.b;
				float temp_output_24_0_g349 = temp_output_302_3;
				...
				float4 tex2DNode15_g342 = tex2D( _GrassControl, temp_output_12_0_g342 );
				float4 tex2DArrayNode35_g342 = SAMPLE_TEXTURE2D_ARRAY( _ShapeMap, sampler_ShapeMap, uv_ShapeMap,( tex2DNode15_g342.g * 255.0 ) );
				float temp_output_24_0_g343 = tex2DArrayNode35_g342.b;
				float4 tex2DNode16_g342 = tex2D( _GrassTint, temp_output_12_0_g342 );
				float temp_output_25_0_g343 = tex2DNode16_g342.a;
				float temp_output_26_0_g343 = tex2DArrayNode32_g342.b;
				float temp_output_41_0_g342 = ( 1.0 - tex2DNode16_g342.a );
				float temp_output_27_0_g343 = temp_output_41_0_g342;
				float temp_output_1_0_g343 = ( max( ( temp_output_24_0_g343 + temp_output_25_0_g343 ) , ( temp_output_26_0_g343 + temp_output_27_0_g343 ) ) - 0.2 );
				float temp_output_21_0_g343 = max( ( ( temp_output_24_0_g343 + temp_output_25_0_g343 ) - temp_output_1_0_g343 ) , 0.0 );
				float temp_output_19_0_g343 = max( ( ( temp_output_26_0_g343 + temp_output_27_0_g343 ) - temp_output_1_0_g343 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch31_g342 = ( ( ( tex2DArrayNode35_g342 * temp_output_21_0_g343 ) + ( tex2DArrayNode32_g342 * temp_output_19_0_g343 ) ) / ( temp_output_21_0_g343 + temp_output_19_0_g343 ) );
				#else
				float4 staticSwitch31_g342 = tex2DArrayNode32_g342;
				#endif
				float temp_output_300_3 = staticSwitch31_g342.b;
				float temp_output_24_0_g347 = temp_output_300_3;
				float temp_output_25_0_g347 = temp_output_274_0;
				float2 temp_output_12_0_g338 = ( ( temp_output_270_0 + float2( 1,1 ) ) / appendResult265 );
				float4 tex2DNode6_g338 = tex2D( _Control, temp_output_12_0_g338 );
				float4 tex2DArrayNode32_g338 = SAMPLE_TEXTURE2D_ARRAY( _ShapeMap, sampler_ShapeMap, uv_ShapeMap,( tex2DNode6_g338.g * 255.0 ) );
				float4 tex2DNode15_g338 = tex2D( _GrassControl, temp_output_12_0_g338 );
				float4 tex2DArrayNode35_g338 = SAMPLE_TEXTURE2D_ARRAY( _ShapeMap, sampler_ShapeMap, uv_ShapeMap,( tex2DNode15_g338.g * 255.0 ) );
				float temp_output_24_0_g339 = tex2DArrayNode35_g338.b;
				float4 tex2DNode16_g338 = tex2D( _GrassTint, temp_output_12_0_g338 );
				float temp_output_25_0_g339 = tex2DNode16_g338.a;
				float temp_output_26_0_g339 = tex2DArrayNode32_g338.b;
				float temp_output_41_0_g338 = ( 1.0 - tex2DNode16_g338.a );
				float temp_output_27_0_g339 = temp_output_41_0_g338;
				float temp_output_1_0_g339 = ( max( ( temp_output_24_0_g339 + temp_output_25_0_g339 ) , ( temp_output_26_0_g339 + temp_output_27_0_g339 ) ) - 0.2 );
				float temp_output_21_0_g339 = max( ( ( temp_output_24_0_g339 + temp_output_25_0_g339 ) - temp_output_1_0_g339 ) , 0.0 );
				float temp_output_19_0_g339 = max( ( ( temp_output_26_0_g339 + temp_output_27_0_g339 ) - temp_output_1_0_g339 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch31_g338 = ( ( ( tex2DArrayNode35_g338 * temp_output_21_0_g339 ) + ( tex2DArrayNode32_g338 * temp_output_19_0_g339 ) ) / ( temp_output_21_0_g339 + temp_output_19_0_g339 ) );
				#else
				float4 staticSwitch31_g338 = tex2DArrayNode32_g338;
				#endif
				float temp_output_301_3 = staticSwitch31_g338.b;
				float temp_output_26_0_g347 = temp_output_301_3;
				float temp_output_27_0_g347 = break273.x;
				float temp_output_1_0_g347 = ( max( ( temp_output_24_0_g347 + temp_output_25_0_g347 ) , ( temp_output_26_0_g347 + temp_output_27_0_g347 ) ) - 0.2 );
				...
				float temp_output_26_0_g350 = temp_output_293_0.z;
				float temp_output_27_0_g350 = break273.y;
				float temp_output_1_0_g350 = ( max( ( temp_output_24_0_g350 + temp_output_25_0_g350 ) , ( temp_output_26_0_g350 + temp_output_27_0_g350 ) ) - 0.2 );
				float temp_output_21_0_g350 = max( ( ( temp_output_24_0_g350 + temp_output_25_0_g350 ) - temp_output_1_0_g350 ) , 0.0 );
				float4 tex2DArrayNode23_g342 = SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,( tex2DNode6_g342.r * 255.0 ) );
				float temp_output_24_0_g344 = tex2DArrayNode35_g342.b;
				float temp_output_25_0_g344 = tex2DNode16_g342.a;
				float temp_output_26_0_g344 = tex2DArrayNode32_g342.b;
				float temp_output_27_0_g344 = temp_output_41_0_g342;
				float temp_output_1_0_g344 = ( max( ( temp_output_24_0_g344 + temp_output_25_0_g344 ) , ( temp_output_26_0_g344 + temp_output_27_0_g344 ) ) - 0.2 );
				float temp_output_21_0_g344 = max( ( ( temp_output_24_0_g344 + temp_output_25_0_g344 ) - temp_output_1_0_g344 ) , 0.0 );
				float temp_output_19_0_g344 = max( ( ( temp_output_26_0_g344 + temp_output_27_0_g344 ) - temp_output_1_0_g344 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch29_g342 = ( ( ( SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,( tex2DNode15_g342.r * 255.0 ) ) * temp_output_21_0_g344 ) + ( tex2DArrayNode23_g342 * temp_output_19_0_g344 ) ) / ( temp_output_21_0_g344 + temp_output_19_0_g344 ) );
				#else
				float4 staticSwitch29_g342 = tex2DArrayNode23_g342;
				#endif
				float temp_output_24_0_g348 = temp_output_300_3;
				float temp_output_25_0_g348 = temp_output_274_0;
				float temp_output_26_0_g348 = temp_output_301_3;
				float temp_output_27_0_g348 = break273.x;
				float temp_output_1_0_g348 = ( max( ( temp_output_24_0_g348 + temp_output_25_0_g348 ) , ( temp_output_26_0_g348 + temp_output_27_0_g348 ) ) - 0.2 );
				float temp_output_21_0_g348 = max( ( ( temp_output_24_0_g348 + temp_output_25_0_g348 ) - temp_output_1_0_g348 ) , 0.0 );
				float4 tex2DArrayNode23_g338 = SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,( tex2DNode6_g338.r * 255.0 ) );
				float temp_output_24_0_g340 = tex2DArrayNode35_g338.b;
				float temp_output_25_0_g340 = tex2DNode16_g338.a;
				float temp_output_26_0_g340 = tex2DArrayNode32_g338.b;
				float temp_output_27_0_g340 = temp_output_41_0_g338;
				float temp_output_1_0_g340 = ( max( ( temp_output_24_0_g340 + temp_output_25_0_g340 ) , ( temp_output_26_0_g340 + temp_output_27_0_g340 ) ) - 0.2 );
				float temp_output_21_0_g340 = max( ( ( temp_output_24_0_g340 + temp_output_25_0_g340 ) - temp_output_1_0_g340 ) , 0.0 );
				float temp_output_19_0_g340 = max( ( ( temp_output_26_0_g340 + temp_output_27_0_g340 ) - temp_output_1_0_g340 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch29_g338 = ( ( ( SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,( tex2DNode15_g338.r * 255.0 ) ) * temp_output_21_0_g340 ) + ( tex2DArrayNode23_g338 * temp_output_19_0_g340 ) ) / ( temp_output_21_0_g340 + temp_output_19_0_g340 ) );
				#else
				float4 staticSwitch29_g338 = tex2DArrayNode23_g338;
				#endif
				...
				float temp_output_26_0_g354 = tex2DArrayNode32_g351.b;
				float temp_output_27_0_g354 = temp_output_41_0_g351;
				float temp_output_1_0_g354 = ( max( ( temp_output_24_0_g354 + temp_output_25_0_g354 ) , ( temp_output_26_0_g354 + temp_output_27_0_g354 ) ) - 0.2 );
				float temp_output_21_0_g354 = max( ( ( temp_output_24_0_g354 + temp_output_25_0_g354 ) - temp_output_1_0_g354 ) , 0.0 );
				float temp_output_19_0_g354 = max( ( ( temp_output_26_0_g354 + temp_output_27_0_g354 ) - temp_output_1_0_g354 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch30_g351 = ( ( ( tex2DNode16_g351 * temp_output_21_0_g354 ) + ( tex2DNode14_g351 * temp_output_19_0_g354 ) ) / ( temp_output_21_0_g354 + temp_output_19_0_g354 ) );
				#else
				...
				float temp_output_26_0_g345 = tex2DArrayNode32_g342.b;
				float temp_output_27_0_g345 = temp_output_41_0_g342;
				float temp_output_1_0_g345 = ( max( ( temp_output_24_0_g345 + temp_output_25_0_g345 ) , ( temp_output_26_0_g345 + temp_output_27_0_g345 ) ) - 0.2 );
				float temp_output_21_0_g345 = max( ( ( temp_output_24_0_g345 + temp_output_25_0_g345 ) - temp_output_1_0_g345 ) , 0.0 );
				float temp_output_19_0_g345 = max( ( ( temp_output_26_0_g345 + temp_output_27_0_g345 ) - temp_output_1_0_g345 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch30_g342 = ( ( ( tex2DNode16_g342 * temp_output_21_0_g345 ) + ( tex2DNode14_g342 * temp_output_19_0_g345 ) ) / ( temp_output_21_0_g345 + temp_output_19_0_g345 ) );
				#else
				...
				float temp_output_26_0_g341 = tex2DArrayNode32_g338.b;
				float temp_output_27_0_g341 = temp_output_41_0_g338;
				float temp_output_1_0_g341 = ( max( ( temp_output_24_0_g341 + temp_output_25_0_g341 ) , ( temp_output_26_0_g341 + temp_output_27_0_g341 ) ) - 0.2 );
				float temp_output_21_0_g341 = max( ( ( temp_output_24_0_g341 + temp_output_25_0_g341 ) - temp_output_1_0_g341 ) , 0.0 );
				float temp_output_19_0_g341 = max( ( ( temp_output_26_0_g341 + temp_output_27_0_g341 ) - temp_output_1_0_g341 ) , 0.0 );
				#ifdef GRASS
				float4 staticSwitch30_g338 = ( ( ( tex2DNode16_g338 * temp_output_21_0_g341 ) + ( tex2DNode14_g338 * temp_output_19_0_g341 ) ) / ( temp_output_21_0_g341 + temp_output_19_0_g341 ) );
				#else
				...
				surfaceDescription.Metallic = ( ( ( temp_output_159_0.w * 2.0 ) - 1.0 ) * _MetalLevel );
