...
Shader "DF/Engraving"
{
	Properties
	{
		...
		[ASEEnd]_ImageAtlas("ImageAtlas", 2DArray) = "white" {}
	...
	SubShader
	{
		...
		Tags { "RenderPipeline"="HDRenderPipeline" "RenderType"="Opaque" "Queue"="AlphaTest" "IgnoreProjector"="True" "ForceNoShadowCasting"="True" }
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				#endif
				float3 vertexValue = float3( float2( -1,-1 ) ,  0.0 );
						...
						)
			{
				...
				float2 uv_ImageAtlas = packedInput.ase_texcoord5.xy * _ImageAtlas_ST.xy + _ImageAtlas_ST.zw;
				float4 break48 = ( float4( uv_ImageAtlas, 0.0 , 0.0 ) * _Color );
				float3 appendResult49 = (float3(break48.r , break48.g , break48.b));
				
				float3 unpack50 = UnpackNormalScale( float4( ( float2( 1,1 ) - uv_ImageAtlas ), 0.0 , 0.0 ), _BumpScale );
				unpack50.z = lerp( 1, unpack50.z, saturate(_BumpScale) );
				
				clip( 1.0 - -0.5);
				
				surfaceDescription.Albedo = appendResult49;
				surfaceDescription.Normal = unpack50;
				...
				surfaceDescription.Alpha = break48.a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ImageAtlas = packedInput.ase_texcoord2.xy * _ImageAtlas_ST.xy + _ImageAtlas_ST.zw;
				float4 break48 = ( float4( uv_ImageAtlas, 0.0 , 0.0 ) * _Color );
				float3 appendResult49 = (float3(break48.r , break48.g , break48.b));
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_ImageAtlas = packedInput.ase_texcoord1.xy * _ImageAtlas_ST.xy + _ImageAtlas_ST.zw;
				float4 break48 = ( float4( uv_ImageAtlas, 0.0 , 0.0 ) * _Color );
				clip( 1.0 - -0.5);
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_ImageAtlas = packedInput.ase_texcoord3.xy * _ImageAtlas_ST.xy + _ImageAtlas_ST.zw;
				float3 unpack50 = UnpackNormalScale( float4( ( float2( 1,1 ) - uv_ImageAtlas ), 0.0 , 0.0 ), _BumpScale );
				unpack50.z = lerp( 1, unpack50.z, saturate(_BumpScale) );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_ImageAtlas = packedInput.ase_texcoord7.xy * _ImageAtlas_ST.xy + _ImageAtlas_ST.zw;
				float4 break48 = ( float4( uv_ImageAtlas, 0.0 , 0.0 ) * _Color );
				float3 appendResult49 = (float3(break48.r , break48.g , break48.b));
...
/*ASEBEGIN
Version=18935
439;51;2560;1335;1165.068;387.4655;1;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;38;-765.0679,119.5345;Inherit;True;Property;_ImageAtlas;ImageAtlas;12;0;Create;True;0;0;0;False;0;False;None;None;False;white;LockedToTexture2DArray;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;39;-552.0679,124.5345;Inherit;False;0;-1;2;3;2;SAMPLER2DARRAY;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;12;-745,304.5;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;-249.0679,230.5345;Inherit;False;2;2;0;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.BreakToComponentsNode;48;-126.0679,231.5345;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.TexturePropertyNode;14;-763,-63.5;Inherit;True;Property;_TileIndex;TileIndex;2;0;Create;True;0;0;0;False;0;False;None;None;False;gray;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.DynamicAppendNode;49;60.93213,-83.46545;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClipNode;47;-1.067871,228.5345;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;-0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;51;-176.0679,410.5345;Inherit;False;2;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.UnpackScaleNormalNode;50;245.9321,277.5345;Inherit;True;Tangent;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;20;-14,362.5;Inherit;False;Property;_BumpScale;BumpScale;7;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-483,665.5;Inherit;False;Property;_ContrbutionEmission;ContrbutionEmission;6;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-487,521.5;Inherit;False;Property;_ContrbutionSmoothness;ContrbutionSmoothness;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-488,450.5;Inherit;False;Property;_ContrbutionAlbedo;ContrbutionAlbedo;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;13;-771,-237.5;Inherit;False;Property;_SpecColor;SpecColor;1;0;Create;True;0;0;0;False;0;False;0.22,0.22,0.22,0.7686275;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-486,594.5;Inherit;False;Property;_ContrbutionNormal;ContrbutionNormal;5;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;34;-277.0679,-61.46545;Inherit;False;FLOAT3;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector4Node;22;36,-355.5;Inherit;False;Property;_MatColor;MatColor;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;29;-266,-730.5;Inherit;False;Property;_ViewMin;ViewMin;10;0;Create;True;0;0;0;False;0;False;-99999,-99999,-99999;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ClipNode;25;-3,-784.5;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClipNode;31;-1,-664.5;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;24;402,-613.5;Inherit;False;Property;_BoundingBox;Bounding Box;10;0;Create;True;0;0;0;False;0;False;0;0;0;False;_BOUNDING_BOX_ENABLED;Toggle;2;Key0;Key1;Create;True;False;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;32;-553.0679,-63.46545;Inherit;True;Property;_TextureSample0;Texture Sample 0;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;23;51,-172.5;Inherit;False;Property;_MatIndex;MatIndex;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;21;277,119.5;Inherit;False;Constant;_Vector0;Vector 0;8;0;Create;True;0;0;0;False;0;False;-1,-1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.WorldPosInputsNode;26;-224,-872.5;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;30;-253,-585.5;Inherit;False;Property;_ViewMax;ViewMax;11;0;Create;True;0;0;0;False;0;False;99999,99999,99999;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;564,-91;Float;False;True;-1;2;Rendering.HighDefinition.DecalShaderGraphGUI;0;2;DF/Engraving;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=AlphaTest=Queue=0;IgnoreProjector=True;ForceNoShadowCasting=True;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-30;False;False;False;False;False;False;False;False;True;True;True;0;True;-15;255;False;-1;255;True;-24;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-16;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;42;Surface Type;0;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Receive Fog;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  Transparent Writes Motion Vector;0;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Depth Test;1;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;0;0;  Energy Conserving Specular;1;0;  Transmission;1;0;Receive Decals;1;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;638027776414259336;DOTS Instancing;0;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position;1;0;0;12;True;True;True;True;True;True;False;False;False;False;True;True;False;;False;0
...
ASEEND*/
//CHKSM=D95595EDE9C21F6BC9D22B57151A01C240C13D78