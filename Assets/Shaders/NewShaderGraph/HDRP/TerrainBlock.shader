...
Shader "DF/TerrainBlock"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		_WorldBounds("WorldBounds", Vector) = (0,0,1,1)
		_SpatterTex("SpatterTex", 2D) = "white" {}
		_BumpMap("ShapeTexture", 2DArray) = "white" {}
		[ASEEnd]_MatTexArray("MatTexArray", 2DArray) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 surf_norm107_g4 = normalWS;
				float height107_g4 = 1.0;
				...
				float dotResult25_g3 = dot( localPerturbNormal107_g4 , float3( 0,1,0 ) );
				float3 normalizedWorldNormal = normalize( normalWS );
				float2 appendResult12_g3 = (float2(normalizedWorldNormal.x , normalizedWorldNormal.z));
				float4 break7_g3 = _WorldBounds;
				float2 appendResult8_g3 = (float2(break7_g3.x , break7_g3.y));
				float2 appendResult9_g3 = (float2(break7_g3.z , break7_g3.w));
				float4 tex2DNode15_g3 = tex2D( _SpatterTex, ( ( appendResult12_g3 - appendResult8_g3 ) / ( appendResult9_g3 - float2( 0,0 ) ) ) );
				float simplePerlin3D16_g3 = snoise( float3( appendResult12_g3 ,  0.0 )*50.0 );
				simplePerlin3D16_g3 = simplePerlin3D16_g3*0.5 + 0.5;
				float lerpResult18_g3 = lerp( 1.0 , -1.0 , ( tex2DNode15_g3.a - simplePerlin3D16_g3 ));
				float temp_output_26_0_g3 = ( dotResult25_g3 >= lerpResult18_g3 ? 0.0 : 0.0 );
				float2 uv_MatTexArray = packedInput.ase_texcoord5.xy;
				float4 texCoord5_g1 = packedInput.uv1;
				texCoord5_g1.xy = packedInput.uv1.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DArrayNode7_g1 = SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,texCoord5_g1.x );
				float4 temp_output_28_0_g3 = ( tex2DNode15_g3 / tex2DNode15_g3.a );
				float layeredBlendVar39_g3 = temp_output_26_0_g3;
				float4 layeredBlend39_g3 = ( lerp( ( tex2DArrayNode7_g1 * packedInput.ase_color ),temp_output_28_0_g3 , layeredBlendVar39_g3 ) );
				
				float2 uv_BumpMap = packedInput.ase_texcoord5.xy;
				float4 tex2DArrayNode10_g1 = SAMPLE_TEXTURE2D_ARRAY( _BumpMap, sampler_BumpMap, uv_BumpMap,texCoord5_g1.y );
				float4 appendResult15_g1 = (float4(1.0 , tex2DArrayNode10_g1.g , tex2DArrayNode10_g1.b , tex2DArrayNode10_g1.a));
				
				float temp_output_3_0_g5 = ( packedInput.ase_color.a * 2.0 );
				float4 temp_cast_5 = (max( ( temp_output_3_0_g5 - 1.0 ) , 0.0 )).xxxx;
				float layeredBlendVar40_g3 = temp_output_26_0_g3;
				float4 layeredBlend40_g3 = ( lerp( temp_cast_5,temp_output_28_0_g3 , layeredBlendVar40_g3 ) );
				
				float4 temp_cast_7 = (tex2DArrayNode7_g1.a).xxxx;
				float layeredBlendVar41_g3 = temp_output_26_0_g3;
				float4 layeredBlend41_g3 = ( lerp( temp_cast_7,temp_output_28_0_g3 , layeredBlendVar41_g3 ) );
				
				float temp_output_13_0_g1 = ( tex2DArrayNode10_g1.b * min( temp_output_3_0_g5 , 1.0 ) );
				float4 temp_cast_9 = (temp_output_13_0_g1).xxxx;
				float layeredBlendVar42_g3 = temp_output_26_0_g3;
				float4 layeredBlend42_g3 = ( lerp( temp_cast_9,temp_output_28_0_g3 , layeredBlendVar42_g3 ) );
				
				surfaceDescription.Albedo = layeredBlend39_g3.xyz;
				surfaceDescription.Normal = UnpackNormalScale( appendResult15_g1, 1.0 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = layeredBlend40_g3.r;
				...
				surfaceDescription.Smoothness = layeredBlend41_g3.r;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = ( layeredBlend42_g3 * step( 0.5 , temp_output_13_0_g1 ) ).r;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord5 = inputMesh.uv1;
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 texCoord5_g1 = packedInput.ase_texcoord5;
				texCoord5_g1.xy = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DArrayNode7_g1 = SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,texCoord5_g1.x );
				float4 temp_output_28_0_g3 = ( tex2DNode15_g3 / tex2DNode15_g3.a );
				float layeredBlendVar39_g3 = temp_output_26_0_g3;
				float4 layeredBlend39_g3 = ( lerp( ( tex2DArrayNode7_g1 * packedInput.ase_color ),temp_output_28_0_g3 , layeredBlendVar39_g3 ) );
				
				float2 uv_BumpMap = packedInput.ase_texcoord4.xy;
				float4 tex2DArrayNode10_g1 = SAMPLE_TEXTURE2D_ARRAY( _BumpMap, sampler_BumpMap, uv_BumpMap,texCoord5_g1.y );
				float4 appendResult15_g1 = (float4(1.0 , tex2DArrayNode10_g1.g , tex2DArrayNode10_g1.b , tex2DArrayNode10_g1.a));
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord3 = inputMesh.ase_texcoord1;
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
					...
					)
			{
				...
				float lerpResult18_g3 = lerp( 1.0 , -1.0 , ( tex2DNode15_g3.a - simplePerlin3D16_g3 ));
				float temp_output_26_0_g3 = ( dotResult25_g3 >= lerpResult18_g3 ? 0.0 : 0.0 );
				float2 uv_BumpMap = packedInput.ase_texcoord2.xy;
				float4 texCoord5_g1 = packedInput.ase_texcoord3;
				texCoord5_g1.xy = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DArrayNode10_g1 = SAMPLE_TEXTURE2D_ARRAY( _BumpMap, sampler_BumpMap, uv_BumpMap,texCoord5_g1.y );
				float temp_output_3_0_g5 = ( packedInput.ase_color.a * 2.0 );
				float temp_output_13_0_g1 = ( tex2DArrayNode10_g1.b * min( temp_output_3_0_g5 , 1.0 ) );
				float4 temp_cast_1 = (temp_output_13_0_g1).xxxx;
				float4 temp_output_28_0_g3 = ( tex2DNode15_g3 / tex2DNode15_g3.a );
				float layeredBlendVar42_g3 = temp_output_26_0_g3;
				float4 layeredBlend42_g3 = ( lerp( temp_cast_1,temp_output_28_0_g3 , layeredBlendVar42_g3 ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_BumpMap = packedInput.ase_texcoord3.xy;
				float4 texCoord5_g1 = packedInput.ase_texcoord4;
				texCoord5_g1.xy = packedInput.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DArrayNode10_g1 = SAMPLE_TEXTURE2D_ARRAY( _BumpMap, sampler_BumpMap, uv_BumpMap,texCoord5_g1.y );
				float4 appendResult15_g1 = (float4(1.0 , tex2DArrayNode10_g1.g , tex2DArrayNode10_g1.b , tex2DArrayNode10_g1.a));
				...
				float4 tex2DArrayNode7_g1 = SAMPLE_TEXTURE2D_ARRAY( _MatTexArray, sampler_MatTexArray, uv_MatTexArray,texCoord5_g1.x );
				float4 temp_cast_2 = (tex2DArrayNode7_g1.a).xxxx;
				float4 temp_output_28_0_g3 = ( tex2DNode15_g3 / tex2DNode15_g3.a );
				float layeredBlendVar41_g3 = temp_output_26_0_g3;
				float4 layeredBlend41_g3 = ( lerp( temp_cast_2,temp_output_28_0_g3 , layeredBlendVar41_g3 ) );
				
				float temp_output_3_0_g5 = ( packedInput.ase_color.a * 2.0 );
				float temp_output_13_0_g1 = ( tex2DArrayNode10_g1.b * min( temp_output_3_0_g5 , 1.0 ) );
				float4 temp_cast_4 = (temp_output_13_0_g1).xxxx;
				float layeredBlendVar42_g3 = temp_output_26_0_g3;
				float4 layeredBlend42_g3 = ( lerp( temp_cast_4,temp_output_28_0_g3 , layeredBlendVar42_g3 ) );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_BumpMap = packedInput.ase_texcoord7.xy;
				float4 tex2DArrayNode10_g1 = SAMPLE_TEXTURE2D_ARRAY( _BumpMap, sampler_BumpMap, uv_BumpMap,texCoord5_g1.y );
				float4 appendResult15_g1 = (float4(1.0 , tex2DArrayNode10_g1.g , tex2DArrayNode10_g1.b , tex2DArrayNode10_g1.a));
        ...
        Pass
        {
					...
					)
			{
				...
				float3 ase_worldPos = packedInput.ase_texcoord2.xyz;
				float3 surf_pos107_g4 = ase_worldPos;
				float3 surf_norm107_g4 = packedInput.normalWS;
				float height107_g4 = 1.0;
				float scale107_g4 = 1.0;
				float3 localPerturbNormal107_g4 = PerturbNormal107_g4( surf_pos107_g4 , surf_norm107_g4 , height107_g4 , scale107_g4 );
				float dotResult25_g3 = dot( localPerturbNormal107_g4 , float3( 0,1,0 ) );
...
/*ASEBEGIN
Version=18935
-1913;48;1920;963;1053;477.5;1;True;True
Node;AmplifyShaderEditor.Vector4Node;13;-147,-245.5;Inherit;False;Property;_WorldBounds;WorldBounds;0;0;Create;True;0;0;0;False;0;False;0,0,1,1;0,0,1,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;16;-211,-36.5;Inherit;True;Property;_MatTexArray;MatTexArray;3;0;Create;True;0;0;0;False;0;False;None;None;False;white;LockedToTexture2DArray;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;15;-208,153.5;Inherit;True;Property;_BumpMap;ShapeTexture;2;0;Create;False;0;0;0;False;0;False;None;None;False;white;LockedToTexture2DArray;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;14;-208,346.5;Inherit;True;Property;_SpatterTex;SpatterTex;1;0;Create;True;0;0;0;False;0;False;None;None;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;12;62,-84.5;Inherit;False;Shared Terrain Block;-1;;1;b776f3412c449054ea53b4333f136f0f;0;5;2;FLOAT4;0,0,0,0;False;4;FLOAT;0.5;False;8;SAMPLER2DARRAY;0;False;9;SAMPLER2DARRAY;0;False;19;SAMPLER2D;0;False;5;FLOAT4;0;FLOAT3;22;COLOR;23;COLOR;24;COLOR;25
...
WireConnection;12;8;16;0
WireConnection;12;9;15;0
WireConnection;12;19;14;0
WireConnection;0;0;12;0
WireConnection;0;1;12;22
WireConnection;0;4;12;23
WireConnection;0;7;12;24
WireConnection;0;9;12;25
ASEEND*/
//CHKSM=35F6FE36FD5E2AB748E49BC379F5B315DC063517