...
Shader "DF/DFTerrain"
{
	Properties
	{
		...
		_TransitionDistance("TransitionDistance", Float) = 80
		[ASEEnd]_TransitionFalloff("TransitionFalloff", Float) = 3
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 appendResult109 = (float3(ase_worldPos.x , _SeaLevel , ase_worldPos.z));
				float3 appendResult110 = (float3(_WorldSpaceCameraPos.x , _SeaLevel , _WorldSpaceCameraPos.z));
				float temp_output_99_0 = ( distance( appendResult109 , appendResult110 ) / _TransitionDistance );
				float3 temp_cast_0 = (temp_output_99_0).xxx;
						...
						)
			{
				...
				float4 tex2DNode5 = tex2D( _ElevationGradient, ( ( ( ( ( ase_worldPos / _Scale ) - temp_cast_0 ) / float3( 3,0,0 ) ) + float3( 100,0,0 ) ) / float3( 280,280,280 ) ).xy );
				float2 uv_BiomeMap = packedInput.ase_texcoord5.xy * _BiomeMap_ST.xy + _BiomeMap_ST.zw;
				float4 lerpResult19 = lerp( tex2DNode5 , tex2D( _BiomeMap, uv_BiomeMap ) , tex2DNode5.a);
				float4 appendResult103 = (float4(lerpResult19.rgb , 0.0));
				
				float3 appendResult109 = (float3(ase_worldPos.x , _SeaLevel , ase_worldPos.z));
				float3 appendResult110 = (float3(_WorldSpaceCameraPos.x , _SeaLevel , _WorldSpaceCameraPos.z));
				float temp_output_99_0 = ( distance( appendResult109 , appendResult110 ) / _TransitionDistance );
				
				surfaceDescription.Albedo = appendResult103.xyz;
				...
				surfaceDescription.Alpha = pow( temp_output_99_0 , _TransitionFalloff );
...
WireConnection;19;2;5;4
WireConnection;5;0;46;0
WireConnection;5;1;28;0
WireConnection;84;0;103;0
WireConnection;84;7;102;0
WireConnection;84;9;100;0
WireConnection;84;11;99;0
ASEEND*/
//CHKSM=E045A7776FF1FEF9F347F5E480299A6F9E84019E