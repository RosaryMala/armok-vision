	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float4 break60 = ( tex2D( _MainTex, uv_MainTex ) * _Color );
				...
				float3 unpack16 = UnpackNormalScale( tex2D( _BumpMap, ( ( appendResult21 * appendResult23 ) + ( appendResult25 + frac( ( appendResult37 * _TimeParameters.y ) ) ) ) ), _BumpScale );
				...
				float3 unpack43 = UnpackNormalScale( tex2D( _DetailNormalMap, ( ( appendResult47 * appendResult46 ) + appendResult49 ) ), _DetailNormalMapScale );
				...
				float2 uv_EmissionMap = packedInput.ase_texcoord5.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
				#ifdef _EMISSIONTOGGLE_ON
				float4 staticSwitch63 = ( tex2D( _EmissionMap, uv_EmissionMap ) * _Emission );
				#else
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_MetallicMap = packedInput.ase_texcoord2.xy * _MetallicMap_ST.xy + _MetallicMap_ST.zw;
				
				float4 color71 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float2 uv_EmissionMap = packedInput.ase_texcoord2.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
				#ifdef _EMISSIONTOGGLE_ON
				float4 staticSwitch63 = ( tex2D( _EmissionMap, uv_EmissionMap ) * _Emission );
				#else
				float4 staticSwitch63 = color71;
				...
				float2 uv_RoughnessMap = packedInput.ase_texcoord2.xy * _RoughnessMap_ST.xy + _RoughnessMap_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float4 color71 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
				float2 uv_EmissionMap = packedInput.ase_texcoord7.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
				#ifdef _EMISSIONTOGGLE_ON
				float4 staticSwitch63 = ( tex2D( _EmissionMap, uv_EmissionMap ) * _Emission );
				#else
				float4 staticSwitch63 = color71;
...
/*ASEBEGIN
Version=18935
-2028;69;2560;1233;2594.5;58.06421;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;13;-712,-385.5;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SinTimeNode;75;-1450.5,414.9358;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;48;-722.6246,448.1672;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector4Node;45;-1303.625,547.1672;Inherit;False;Property;_DetailNormalMap_ST;DetailNormalMap_ST;15;1;[HideInInspector];Create;True;0;0;0;False;0;False;0,0,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-846.6246,445.1672;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;47;-968.6246,445.1672;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;41;-497.6246,170.1672;Inherit;True;Property;_TextureSample2;Texture Sample 2;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=3A597802F9FEF97AB0FB40F77864FDA89AC91980