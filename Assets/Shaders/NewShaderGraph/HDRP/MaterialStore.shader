...
Shader "DF/MaterialStore"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		_MainTex("MainTex", 2D) = "white" {}
		_SpecGlossMap("Roughness", 2D) = "white" {}
		_Normal("Normal", 2D) = "bump" {}
		_Occlusion("Occlusion", 2D) = "white" {}
		_Height("Height", 2D) = "white" {}
		_Color("Color", Color) = (1,1,1,1)
		[Toggle(_USEDFCOLOR_ON)] _useDFColor("useDFColor", Float) = 1
		_HeightPreview("HeightPreview", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _USEDFCOLOR_ON
						...
						)
			{
				...
				#ifdef _USEDFCOLOR_ON
				float4 staticSwitch32 = _Color;
				#else
				float4 staticSwitch32 = tex2DNode39;
				#endif
				float2 uv_Height = packedInput.ase_texcoord5.xy * _Height_ST.xy + _Height_ST.zw;
				float4 tex2DNode35 = tex2D( _Height, uv_Height );
				float HeightMask52 = saturate(pow(((tex2DNode35.r*tex2DNode35.r)*4)+(tex2DNode35.r*2),_HeightPreview));
				float4 lerpResult60 = lerp( ( tex2DNode39 * staticSwitch32 ) , staticSwitch32 , HeightMask52);
				
				float2 uv_Normal = packedInput.ase_texcoord5.xy * _Normal_ST.xy + _Normal_ST.zw;
				
				float2 uv_SpecGlossMap = packedInput.ase_texcoord5.xy * _SpecGlossMap_ST.xy + _SpecGlossMap_ST.zw;
				
				float2 uv_Occlusion = packedInput.ase_texcoord5.xy * _Occlusion_ST.xy + _Occlusion_ST.zw;
				
				surfaceDescription.Albedo = lerpResult60.rgb;
				...
				surfaceDescription.Smoothness = ( tex2D( _SpecGlossMap, uv_SpecGlossMap ) * _Roughness ).r;
				surfaceDescription.Occlusion = tex2D( _Occlusion, uv_Occlusion ).r;
				surfaceDescription.Alpha = ( tex2DNode39.a * HeightMask52 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 staticSwitch32 = tex2DNode39;
				#endif
				float2 uv_Height = packedInput.ase_texcoord2.xy * _Height_ST.xy + _Height_ST.zw;
				float4 tex2DNode35 = tex2D( _Height, uv_Height );
				float HeightMask52 = saturate(pow(((tex2DNode35.r*tex2DNode35.r)*4)+(tex2DNode35.r*2),_HeightPreview));
				float4 lerpResult60 = lerp( ( tex2DNode39 * staticSwitch32 ) , staticSwitch32 , HeightMask52);
				...
				float2 uv_SpecGlossMap = packedInput.ase_texcoord2.xy * _SpecGlossMap_ST.xy + _SpecGlossMap_ST.zw;
				
				float2 uv_Occlusion = packedInput.ase_texcoord2.xy * _Occlusion_ST.xy + _Occlusion_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode39 = tex2D( _MainTex, uv_MainTex );
				float2 uv_Height = packedInput.ase_texcoord1.xy * _Height_ST.xy + _Height_ST.zw;
				float4 tex2DNode35 = tex2D( _Height, uv_Height );
				float HeightMask52 = saturate(pow(((tex2DNode35.r*tex2DNode35.r)*4)+(tex2DNode35.r*2),_HeightPreview));
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_SpecGlossMap = packedInput.ase_texcoord3.xy * _SpecGlossMap_ST.xy + _SpecGlossMap_ST.zw;
				
				float2 uv_MainTex = packedInput.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode39 = tex2D( _MainTex, uv_MainTex );
				float2 uv_Height = packedInput.ase_texcoord3.xy * _Height_ST.xy + _Height_ST.zw;
				float4 tex2DNode35 = tex2D( _Height, uv_Height );
				float HeightMask52 = saturate(pow(((tex2DNode35.r*tex2DNode35.r)*4)+(tex2DNode35.r*2),_HeightPreview));
		...
		Pass
		{
						...
						)
			{
				...
				float4 staticSwitch32 = tex2DNode39;
				#endif
				float2 uv_Height = packedInput.ase_texcoord7.xy * _Height_ST.xy + _Height_ST.zw;
				float4 tex2DNode35 = tex2D( _Height, uv_Height );
				float HeightMask52 = saturate(pow(((tex2DNode35.r*tex2DNode35.r)*4)+(tex2DNode35.r*2),_HeightPreview));
				float4 lerpResult60 = lerp( ( tex2DNode39 * staticSwitch32 ) , staticSwitch32 , HeightMask52);
				...
				float2 uv_SpecGlossMap = packedInput.ase_texcoord7.xy * _SpecGlossMap_ST.xy + _SpecGlossMap_ST.zw;
				
				float2 uv_Occlusion = packedInput.ase_texcoord7.xy * _Occlusion_ST.xy + _Occlusion_ST.zw;
...
/*ASEBEGIN
Version=18935
-1920;0;1920;1011;1554.946;570.2259;1.3;True;True
Node;AmplifyShaderEditor.TexturePropertyNode;18;-632,771.5;Inherit;True;Property;_Height;Height;4;0;Create;True;0;0;0;False;0;False;None;None;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;37;-303,953.5;Inherit;False;Property;_HeightPreview;HeightPreview;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;35;-415,766.5;Inherit;True;Property;_TextureSample0;Texture Sample 0;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;12;-630,-360.5;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.HeightMapBlendNode;52;56,-88.5;Inherit;False;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;39;-424,-361.5;Inherit;True;Property;_TextureSample1;Texture Sample 1;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;47;-431,191.5;Inherit;True;Property;_TextureSample3;Texture Sample 3;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;49;-417,578.5;Inherit;True;Property;_TextureSample5;Texture Sample 5;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;17;-633,582.5;Inherit;True;Property;_Occlusion;Occlusion;3;0;Create;True;0;0;0;False;0;False;None;None;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;46;119,98.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-143,22.5;Inherit;False;Property;_Metallic;Metallic;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;32;-217,-174.5;Inherit;False;Property;_useDFColor;useDFColor;6;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;61;296,22.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;42;-422,392.5;Inherit;True;Property;_TextureSample2;Texture Sample 2;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;13;-426,-176.5;Inherit;False;Property;_Color;Color;5;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;40;14,-358.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateShaderPropertyNode;62;-455.1461,21.2741;Inherit;False;0;0;_BlendMode;Shader;False;0;5;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;60;173,-347.5;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TexturePropertyNode;14;-647,189.5;Inherit;True;Property;_SpecGlossMap;Roughness;1;0;Create;False;0;0;0;False;0;False;None;None;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;44;-143,121.5;Inherit;False;Property;_Roughness;Roughness;9;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;15;-635,389.5;Inherit;True;Property;_Normal;Normal;2;0;Create;True;0;0;0;False;0;False;None;None;False;bump;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;424,-87;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;2;DF/MaterialStore;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-30;False;False;False;False;False;False;False;False;False;True;True;0;True;-15;255;False;-1;255;True;-14;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-16;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;42;Surface Type;1;638025809190423156;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;0;638025816459846558;  Receive Fog;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  Transparent Writes Motion Vector;0;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Depth Test;1;0;  ZWrite;0;638025816534546180;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;0;0;  Energy Conserving Specular;1;0;  Transmission;1;0;Receive Decals;0;638025809289704130;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;0;638026807415541888;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;638025817230597767;DOTS Instancing;0;0;LOD CrossFade;0;0;Tessellation;0;638025815971747241;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position;1;0;0;12;True;True;True;True;True;True;False;False;False;False;True;True;False;;False;0
WireConnection;35;0;18;0
WireConnection;52;0;35;0
WireConnection;52;1;35;0
WireConnection;52;2;37;0
...
WireConnection;0;8;49;0
WireConnection;0;9;61;0
ASEEND*/
//CHKSM=980A570C20ACB0F0BEF457B83A72C1E65449DAEB